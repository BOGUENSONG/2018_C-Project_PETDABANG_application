...
#pragma endregion
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) { //회원가입버튼 클릭
		this->Hide();
		OOP::Register REgister;
		REgister.ShowDialog(); //회원가입폼창 띄우기
		this->Close();
		
	}

	private: System::Void button2_Click_1(System::Object^  sender, System::EventArgs^  e) { //로그인버튼 클릭
		this->Hide();
		OOP::RealLogin realLogin;
		realLogin.ShowDialog(); //로그인 폼창 띄우기
		this->Close();
	}
